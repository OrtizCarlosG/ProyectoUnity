...
public class Server
{
    ...
    private static void InitializeServerData()
    {
        ...
        packetHandlers = new Dictionary<int, PacketHandler>()
        {
            ...
            { (int)ClientPackets.requestInventory, ServerHandle.ReturnInventory },
            { (int)ClientPackets.takeItem, ServerHandle.TakeItem },
            { (int)ClientPackets.dropItem, ServerHandle.DropItem },
            { (int)ClientPackets.removeAttachment, ServerHandle.RemoveAttachment },
            { (int)ClientPackets.addAttachment, ServerHandle.AddAttachment }
        };

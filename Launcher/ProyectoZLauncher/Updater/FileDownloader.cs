...
namespace ProyectoZLauncher.Updater
{
    class FileDownloader
    {
        ...
        public static void DownloadFile()
        {
            ...
            webClient.DownloadFileAsync(new Uri(Globals.ServerURL +"\\ProyectoZLauncher\\Archivos\\" + Globals.OldFiles[curFile]), Globals.OldFiles[curFile]);
        }
